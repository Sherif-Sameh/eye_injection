...
ROOM_CFG = {
    "Ground": RigidObjectCfg(
        ...
        spawn=sim_utils.CuboidCfg(
            ...
            visual_material=sim_utils.PreviewSurfaceCfg(
                diffuse_color=(0.7, 0.7, 0.7), roughness=0.2
            ),
        ),
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, 0.0, -ROOM_THICKNESS / 2)),
    ),
    "Wall_PosX": RigidObjectCfg(
        ...
        spawn=sim_utils.CuboidCfg(
            ...
            visual_material=sim_utils.PreviewSurfaceCfg(
                diffuse_color=(0.3, 0.3, 0.3), roughness=0.9
            ),
        ),
        init_state=RigidObjectCfg.InitialStateCfg(pos=(ROOM_SIZE / 2, 0.0, ROOM_HEIGHT / 2)),
    ),
    ...
    "Wall_PosY": RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.0, ROOM_SIZE / 2, ROOM_HEIGHT / 2)),
    ),
